...
import { loadPosts, loadMorePosts, likePost, dislikePost, toggleExpandedPost, addPost, likeComment, dislikeComment} from './actions';
...
class Thread extends React.Component {
    ...
    loadMorePosts = () => {
        this.postsFilter.from = this.props.posts.length;
