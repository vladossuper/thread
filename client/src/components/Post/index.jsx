...
const Post = ({ post, dislikePost, likePost, toggleExpandedPost, sharePost /*changePost*/ }) => {
    const {
        id,
        image,
        body,
    ...
    return (
        <Card style={{ width: '100%' }}>
            ...
            <Card.Content extra>
                ...
                {/* <Label basic size="small" as="a" className={styles.toolbarBtn}  onClick={() => changePost(id)}>
                    <Icon name="edit" />
                </Label> */}
            </Card.Content>
        </Card>
